...
var quizLength = 5; //sets the quiz length
...
//users score is stored in localStorage so that they can have all results available to them
...
//////// START HERE /////////
//finish following function so that nativeLanguageWord is not chosen twice in same quiz
